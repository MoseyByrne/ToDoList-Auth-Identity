...
{
  [Authorize] // This allows access to the ItemsController only if a user is logged in.
  public class ItemsController : Controller
  {
    ...
    {
      var userId = this.User.FindFirst(ClaimTypes.NameIdentifier)?.Value;//existential operator. It states that we should only call the property to the right of the ? if the method to the left of the ? doesn't return null.
